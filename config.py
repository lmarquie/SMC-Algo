...
# Risk Management
BACKTEST_RISK_PER_TRADE = 150
LIVE_RISK_PER_TRADE = 0.2

# Strategy Parameters (ACTUALLY USED)
DISPLACEMENT_THRESHOLD = 0.3  # Used in displacement detection
STOP_LOSS_BUFFER = 0.0005  # Used in stop loss calculations
...
MIN_FVG_STRENGTH = 0.00_010 # 0.005 % minimum FVG strength
MIN_LARGER_TREND_CONFIDENCE = 0.50 # 0.75 is good

REVERSAL_CONSTRAINT_ENABLED = True
REQUIRE_SETUP_INDICATORS = True

# Notifications
MUTE_RATE_LIMIT_ALERTS = True  # Suppress Telegram alerts for API rate limiting (HTTP 429)